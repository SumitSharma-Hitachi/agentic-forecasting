...
- **Copper forecasting (shipped)** — `implementations/copper_forecasting/` adds a cache-first FRED commodity workflow with naive and traditional baselines, AutoARIMA and Kalman forecasting, forecast combinations, three agent information designs, and a visual three-period backtest analysis.
